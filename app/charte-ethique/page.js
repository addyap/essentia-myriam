export const metadata = { title: 'Charte éthique — Essentia by MDB' };
  ...
  return (
    <section>
      <div className="wrap" style={{ maxWidth: 780 }}>
        ...
        <h2 className="big">Charte éthique</h2>
        ...
        <h3 style={{ fontSize: 22, marginTop: 32, marginBottom: 10 }}>Confidentialité</h3>
        <p className="prose">
        ...
        <h3 style={{ fontSize: 22, marginTop: 32, marginBottom: 10 }}>Non-jugement et bienveillance</h3>
        <p className="prose">
          Chaque personne est accueillie sans jugement, dans le respect de son rythme, de sa
          singularité et de son histoire.
        </p>

        <h3 style={{ fontSize: 22, marginTop: 32, marginBottom: 10 }}>Autonomie et consentement</h3>
        <p className="prose">
        ...
        <h3 style={{ fontSize: 22, marginTop: 32, marginBottom: 10 }}>Limites de compétence</h3>
        <p className="prose">
        ...
        <h3 style={{ fontSize: 22, marginTop: 32, marginBottom: 10 }}>Autonomisation, non dépendance</h3>
        <p className="prose">
        ...
        <h3 style={{ fontSize: 22, marginTop: 32, marginBottom: 10 }}>Respect de la diversité</h3>
        <p className="prose">
