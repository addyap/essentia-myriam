export const metadata = { title: 'Confidentialité — Essentia by MDB' };
  ...
  return (
    <section>
      <div className="wrap" style={{ maxWidth: 780 }}>
        ...
        <h2 className="big">Politique de confidentialité</h2>
        <div className="divider" />
        <p className="lead" style={{ margin: '10px 0 0' }}>
          Comment vos données personnelles sont collectées et utilisées sur ce site.
        </p>

        <h3 style={{ fontSize: 22, marginTop: 32, marginBottom: 10 }}>Quelles données sont collectées</h3>
        <p className="prose">
        ...
        <h3 style={{ fontSize: 22, marginTop: 32, marginBottom: 10 }}>Pourquoi ces données sont utilisées</h3>
        <p className="prose">
        ...
        <h3 style={{ fontSize: 22, marginTop: 32, marginBottom: 10 }}>Durée de conservation</h3>
        <p className="prose">
        ...
        <h3 style={{ fontSize: 22, marginTop: 32, marginBottom: 10 }}>Vos droits</h3>
        <p className="prose">
        ...
        <h3 style={{ fontSize: 22, marginTop: 32, marginBottom: 10 }}>Contact</h3>
        <p className="prose">
