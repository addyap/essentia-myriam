export const metadata = { title: 'RGPD — Essentia by MDB' };
  ...
  return (
    <section>
      <div className="wrap" style={{ maxWidth: 780 }}>
        ...
        <h2 className="big">Protection des données (RGPD)</h2>
        <div className="divider" />
        <p className="lead" style={{ margin: '10px 0 0' }}>
          Vos droits en tant que personne concernée, et comment les exercer.
        </p>

        <h3 style={{ fontSize: 22, marginTop: 32, marginBottom: 10 }}>Responsable du traitement</h3>
        <p className="prose">
        ...
        <h3 style={{ fontSize: 22, marginTop: 32, marginBottom: 10 }}>Comment exercer ces droits</h3>
        <p className="prose">
        ...
        <h3 style={{ fontSize: 22, marginTop: 32, marginBottom: 10 }}>Réclamation</h3>
        <p className="prose">
